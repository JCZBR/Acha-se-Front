      ...
      <Galeria>
        <Form>
          ...
          <Form2>
            ...
            RG: <br />
            <br />
            <FormCriarItem onChange={(e) => setFormData({ ...formData, rg: e.target.value })} type="text" className="FormCriarItem" />
          ...
          <Form2>
            ...
            CPF: <br />
            <br />
            <FormCriarItem onChange={(e) => setFormData({ ...formData, cpf: e.target.value })} type="text" className="FormCriarItem" />
          </Form2>
          
        </Form >
      </Galeria>
      <div style={{ display: "flex", marginTop: "20px" }}>
        <BotaoItem className="botaoitem" onClick={handleDevolution}>Marcar item como devolvido</BotaoItem>
      </div>
    </>
  )
};
